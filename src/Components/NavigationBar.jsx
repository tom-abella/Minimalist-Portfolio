        ...
        <div className="fixed w-full z-40 py-2 uppercase font-medium text-gray-300 bg-gray-900">
            <div className="flex justify-around font-pop">
                ...
                <ul className="flex flex-row justify-center items-center">
                    ...
                    <li className="mx-2 p-2 hover:text-gray-500 cursor-pointer hover:border-b-2 hover:border-gray-500 border-b-2 border-gray-900"><Link to ="project"spy={true} smooth={true} duration={500}>Project</Link></li>
                    <li className="mx-2 p-2 hover:text-gray-500 cursor-pointer hover:border-b-2 hover:border-gray-500 border-b-2 border-gray-900"><Link to ="timeline"spy={true} smooth={true} duration={500}>Timeline</Link></li>
                </ul>
