      ...
      <div className="bg-gray-900 h-full w-full font-pop px-4 overflow-hidden " id="project">
        ...
        <p className="text-gray-300 p-4 border-b-2 mb-10 border-gray-200 text-4xl">Project</p>
          {/* Project 1*/}
            ...
            <div className="w-96 h-115 p-3 border-2 rounded-lg border-gray-500 m-3 hover:bg-gray-300 hover:text-gray-900 text-gray-300" data-aos="fade-up" data-aos-duration="300">
              <ul className="text-gray-300 flex flex-col gap-3">
                ...
                <li className="flex justify-evenly items-cente">
                    <a href="https://tom-abella.github.io/Alternative-Education-Platform/" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-blue-300 text-gray-600"><BsGlobe size={30}/></a>
                    <p className="text-center text-xl uppercase font-bold">alternative learning platform</p>
                    <a href="https://github.com/tom-abella/Alternative-Education-Platform" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-blue-300 text-gray-600"><BsCodeSlash size={30}/></a>
                </li>
            ...
            <div className="w-96 h-115 p-3 border-2 rounded-lg border-gray-500 m-3 hover:bg-gray-300 hover:text-gray-900 text-gray-300" data-aos="fade-up" data-aos-duration="400">
              <ul className="text-gray-300 flex flex-col gap-3">
                ...
                <li className="flex justify-evenly items-cente">
                    ...
                    <a href="https://github.com/tom-abella/Card_Bank" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-blue-700 text-gray-600"><BsCodeSlash size={30}/></a>
                </li>
                <li className="flex flex-row justify-center items-center gap-2 ">
                  <p>Stack:</p><SiBootstrap size={20} className="text-purple-400"/>
                  </li>
            ...
            {/* Project 3*/}
            <div className="w-96 h-115 p-3 border-2 rounded-lg border-gray-500 m-3 hover:bg-gray-300 hover:text-gray-900 text-gray-300" data-aos="fade-up" data-aos-duration="500">
              <ul className="flex flex-col gap-3">
                <li><img src={firstPortfolio} alt="old portfolio" className="rounded-lg" /></li>
                <li className="flex justify-evenly items-cente">
                    <a href="https://tom-abella.github.io/Portfolio/" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-blue-700 text-gray-600"><BsGlobe size={30}/></a>
                    <p className="text-center text-xl uppercase font-bold">Portfolio</p>
                    <a href="https://github.com/tom-abella/tom-abella.github.io/tree/main/Portfolio" target={"_blank"}className="py-1 rounded-lg px-4 hover:text-blue-700 text-gray-600"><BsCodeSlash size={30}/></a>
                </li>
                <li className="flex flex-row justify-center items-center gap-2 ">
                  <p>Stack:</p><SiBootstrap size={20} className="text-purple-400"/>
                  </li>
            ...
            {/* Project 4*/}
            <div className="w-96 h-115 p-3 border-2 rounded-lg border-gray-500 m-3 hover:bg-gray-300 hover:text-gray-900 text-gray-300" data-aos="fade-up" data-aos-duration="600">
              <ul className="flex flex-col gap-3">
                <li><img src={businessCard} alt="business card" className="rounded-lg"/></li>
                <li className="flex justify-evenly items-cente">
                    <a href="https://tomleonard-digital-business-card.vercel.app/" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-blue-700 text-gray-600"><BsGlobe size={30}/></a>
                    <p className="text-center text-xl uppercase font-bold">business card</p>
                    <a href="https://github.com/tom-abella/Digital-Business-Card" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-blue-700 text-gray-600"><BsCodeSlash size={30}/></a>
                </li>
                <li className="flex flex-row justify-center items-center gap-2 ">
            ...
            {/* Project 5*/}
            <div className="w-96 h-115 p-3 border-2 rounded-lg border-gray-500 m-3 hover:bg-gray-300 hover:text-gray-900 text-gray-300" data-aos="fade-up" data-aos-duration="700">
              <ul className=" flex flex-col gap-3">
                <li ><img src={travelJournal} alt="travel journal" className="rounded-lg"/></li>
                <li className="flex justify-evenly items-cente">
                    <a href="https://tomleonard-travel-journal.vercel.app/" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-blue-700 text-gray-600"><BsGlobe size={30}/></a>
                    <p className="text-center text-xl uppercase font-bold">travel journal</p>
                    <a href="https://github.com/tom-abella/travel-journal" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-blue-700 text-gray-600"><BsCodeSlash size={30}/></a>
                </li>
                <li className="flex flex-row justify-center items-center gap-2 " >
                  <p>Stack:</p> <SiReact size={20} className="text-blue-300"/><SiBootstrap size={20} className="text-purple-400"/>
                  </li>
            ...
            {/* Project 6*/}
            <div className="w-96 h-115 border-2 rounded-lg border-gray-500 m-3 px-3 py-4 hover:bg-gray-300 hover:text-gray-900 text-gray-300" data-aos="fade-up" data-aos-duration="800">
              <ul className="flex flex-col gap-3">
                <li><img src={secondPortfolio} alt="Portfolio" className="rounded-lg"/></li>
                <li className="flex justify-evenly items-cente">
                    <a href="https://tomleonard-abella.vercel.app/" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-blue-700 text-gray-600"><BsGlobe size={30}/></a>
                    <p className="text-center text-xl uppercase font-bold">portfolio</p>
                    <a href="https://github.com/tom-abella/Minimalist-Portfolio" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-blue-700 text-gray-600"><BsCodeSlash size={30}/></a>
                </li>
            ...
            {/* Project 7*/}
            <div className="w-96 h-115 border-2 rounded-lg border-gray-500 m-3 px-3 py-2 hover:bg-gray-300 hover:text-gray-900 text-gray-300 "  data-aos="fade-up" data-aos-duration="900">
              <ul className=" flex flex-col gap-3">
                <li><img src={ddcMain} alt="ddcMain" className="rounded-xl"/></li>
                <li className="flex justify-evenly items-cente">
                    <a href="https://donesdentalclinic.vercel.app/" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-blue-700 text-gray-600"><BsGlobe size={30}/></a>
                    <p className="text-center text-xl uppercase font-bold">Dental clinic</p>
                    <a href="https://github.com/tom-abella/dental-clinic-scheduler" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-blue-700 text-gray-600"><BsCodeSlash size={30}/></a>
                </li>
            ...
            {/* Project 8*/}
            <div className="w-96 h-115 border-2 rounded-lg border-gray-500 m-3 px-3 py-4 hover:bg-gray-300 hover:text-gray-900 text-gray-300" data-aos="fade-up" data-aos-duration="1000">
              <ul className="flex flex-col gap-3 ">
                <li><img src={ddcAdmin} alt="ddcAdmin" className="rounded-lg"/></li>
                <li className="flex justify-evenly items-center">
                    <a href="https://ddc-admin.vercel.app/" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-blue-700 text-gray-600"><BsGlobe size={30}/></a>
