          ...
          {/* Project 1*/}
            ...
            <div className="w-96 h-115 p-3 border-2 rounded-lg border-gray-500 m-3 hover:bg-gray-300 hover:text-gray-900 text-gray-300" data-aos="fade-up" data-aos-duration="400">
              <ul className="text-gray-300 flex flex-col gap-3">
                ...
                <li className="flex justify-evenly items-cente">
                    <a href="https://card-bank-92vryqdox-tom-abella.vercel.app/" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-gray-700 text-gray-600"><BsGlobe size={30}/></a>
                    <p className="text-center text-xl uppercase font-bold">card bank</p>
                    <a href="https://github.com/tom-abella/Card_Bank" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-gray-700 text-gray-600"><BsCodeSlash size={30}/></a>
                </li>
                <li className="flex flex-row justify-center items-center gap-2 ">
                  <p>Stack:</p><SiBootstrap size={20} className="text-purple-400"/>
                  </li>
