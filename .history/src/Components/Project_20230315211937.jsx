          ...
          {/* Project 1*/}
            ...
            <div className="w-96 h-96 border-2 rounded-lg border-gray-500 m-3 px-3 py-4" data-aos="fade-up" data-aos-duration="800">
              <ul className="text-gray-300 mb-4">
                ...
                <li className="flex justify-evenly items-center my-2">
                    <a href="https://tomleonard-abella.vercel.app/" target={_} className="py-1 rounded-lg px-4 hover:text-gray-300 text-gray-600"><BsGlobe size={30}/></a>
                    <p className="text-center text-xl uppercase font-bold">portfolio</p>
                    <a href="" className="py-1 rounded-lg px-4 hover:text-gray-300 text-gray-600"><BsCodeSlash size={30}/></a>
                </li>
