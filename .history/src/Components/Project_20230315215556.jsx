      ...
      <div className="bg-gray-900 h-full w-full font-pop px-4 overflow-hidden " id="project">
        ...
        <p className="text-gray-300 p-4 border-b-2 mb-10 border-gray-200 text-4xl">Project</p>
          {/* Project 1*/}
            ...
            {/* Project 7*/}
            <div className="w-96 h-115 border-2 rounded-lg border-gray-500 m-3 px-3 py-2" data-aos="fade-up" data-aos-duration="900">
              <ul className="text-gray-300 mb-4">
                ...
                <li className="flex justify-evenly items-center my-2">
                  ...
                  <li className="flex flex-row justify-center items-center gap-2 mb-2"><p>Stack:</p> <SiReact size={20} className="text-blue-300"/><SiTailwindcss size={20} className="text-blue-400"/> <SiFirebase size={20} className="text-orange-500"/>
                  </li>
                <li className="mb-5">a webpage that shows information about a dental clinic and a has form that will make the user to book online.</li>
              </ul>
            </div>
            {/* Project 8*/}
            <div className="w-96 h-115 border-2 rounded-lg border-gray-500 m-3 px-3 py-4" data-aos="fade-up" data-aos-duration="1000">
              <ul className="text-gray-300">
                ...
                <li className="flex justify-evenly items-center">
                  ...
                  <li className="flex flex-row justify-center items-center "><p>Stack:</p> <SiReact size={20} className="text-blue-300"/><SiTailwindcss size={20} className="text-blue-400"/><SiFirebase size={20} className="text-orange-500"/>
                  </li>
                <li className="mb-5">Dental clinic admin shows the completed clients and who book online. It also shows who are the authorized user to login in the admin</li>
              </ul>
            </div>
            </div>
        </div>
