            ...
            <div className="w-96 h-115 border-2 rounded-lg border-gray-200 m-3 px-3 py-2 hover:bg-gray-300 hover:text-gray-900 text-gray-300"  data-aos="fade-up" data-aos-duration="900">
              <ul className=" flex flex-col gap-3">
                ...
                <li className="flex justify-evenly items-cente">
                    ...
                    <a href="https://github.com/tom-abella/dental-clinic-scheduler" target={"_blank"} className="py-1 rounded-lg px-4 hover:text-gray-900 text-gray-600"><BsCodeSlash size={30}/></a>
                </li>
